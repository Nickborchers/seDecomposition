...
void set_data_byte(unsigned char *line, int i, unsigned char val){
    line[i] = val;
}

unsigned char get_data_byte(unsigned char *){
 ...
 */
void
dilateGrayLow(unsigned char  *datad,
              int    w,
              int    h,
              unsigned char  *datas,
              int    size,
...
{
    int i, j, k;
    int hsize, nsteps, startmax, startx, starty;
